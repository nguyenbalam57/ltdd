...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng cuahangdienthoai = new LatLng(10.789816, 106.635044);
        mMap.addMarker(new MarkerOptions().position(cuahangdienthoai).title("Cửa hàng điện thoại Tương & Qúi").snippet("28 Nguyễn Hậu, Phường Hòa Thạnh, Quận Tân Phú").icon(BitmapDescriptorFactory.defaultMarker()));
